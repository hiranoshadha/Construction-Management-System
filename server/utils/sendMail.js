...
<head>
  ...
  <title>Apex Construction - Email</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>Best regards,<br> The Apex Construction Team</p>
    </div>
  </div>
</body>
</html>
...
export function sendEmployeeInitialPassword(employeeName, employeeMail, password) {

    var content = `
    <p>We are excited to welcome you to our team at Apex Construction. Your employee account has been successfully created.</p>
    ...
    var subject = "Welcome to Apex Construction: Your Employee Account Details";
